...
const SERVICE_DEFINITIONS: ServiceDefinition[] = [
  ...
  },
  {
    id: "yookassa",
    name: "ЮKassa",
    description: "Пополнение баланса и обработка платежных callback-событий.",
    requiredEnv: ["YOOKASSA_SHOP_ID", "YOOKASSA_SECRET_KEY", "YOOKASSA_WEBHOOK_SECRET"],
    optionalEnv: ["YOOKASSA_RETURN_URL", "USD_PER_CREDIT"],
  ...
  },
  {
    id: "mail",
    name: "UniSender",
    description: "Основной канал отправки писем с резервным SMTP-режимом.",
    ...
    docsUrl: "https://www.unisender.com/ru/support/api/common/",
  },
  {
    id: "upstash",
    name: "Upstash Redis",
...
const API_ENDPOINTS: AdminApiEndpoint[] = [
  ...
  },
  {
    ...
    path: "/api/ai/image",
    access: "auth user",
    description: "Описание загруженного изображения через vision-модель.",
  },
  {
    serviceId: "openrouter",
    method: "POST",
    ...
    access: "auth user",
    description: "Генерация изображений через image-модели OpenRouter.",
  },
  {
    serviceId: "openrouter",
    method: "GET",
    path: "/api/images",
    access: "auth user",
    description: "Галерея изображений текущего пользователя.",
  },
  {
    serviceId: "openrouter",
    method: "POST",
    path: "/api/ai/chat-image",
    access: "auth user",
    description: "Генерация изображения из обычного чата.",
  },
  {
    serviceId: "openrouter",
    method: "GET",
